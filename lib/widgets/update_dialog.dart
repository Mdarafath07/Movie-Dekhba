...
class _UpdateDialogState extends State<UpdateDialog> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final cardBg = isDark ? const Color(0xFF1E1E1E).withOpacity(0.85) : Colors.white.withOpacity(0.85);
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Version ${widget.latestVersion} is here',
                              ...
                              if (widget.newFeatures.isNotEmpty) ...[
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: widget.newFeatures.take(3).map((f) => Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 4),
                                      child: Row(
                                        children: [
                                          const Icon(Icons.auto_awesome, size: 12, color: Color(0xFFE50914)),
                              ...
                              Container(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    final url = Uri.parse(widget.updateLink);
